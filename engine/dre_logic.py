...
class DRELogic:
    ...
    def calcular_realizado(
        ...
        # Garantir que DATA_EMISSAO e datetime
        if "DATA_EMISSAO" in df_filtrado.columns and not pd.api.types.is_datetime64_any_dtype(df_filtrado["DATA_EMISSAO"]):
            df_filtrado["DATA_EMISSAO"] = pd.to_datetime(df_filtrado["DATA_EMISSAO"], errors="coerce")
